...
mpiexec  -n $((NP_OFILE)) ${SNOBIN} ${conf_bulk}.\${PJM_BULKNUM}
...
#pjsub --bulk --sparam 1-20 job_sno.sh 
#sleep 300
#pjsub --bulk --sparam "51-100" job_sno.sh 
#pjsub  job_sno.sh 
cd - > /dev/null
