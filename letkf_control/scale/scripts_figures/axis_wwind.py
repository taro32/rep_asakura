...
def calc_axis (strday, strhour):
    ...
    np.savetxt('waxis_20250918_tchires_letkc_L1_negativeQonly_lamda09_psobs_target960error1_window1h_'+str(strday)+str(strhour)+'.txt', valueaxis)
    ...
    plt.colorbar()
    plt.savefig('waxis_20250918_tchires_letkc_L1_negativeQonly_lamda09_psobs_target960error1_window1h_'+str(strday)+str(strhour)+'.png')
