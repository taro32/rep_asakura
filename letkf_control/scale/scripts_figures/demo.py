...
workdir_letkf = '/work/gv42/f00019/enkc_with_TC/20250914_tchires_letkc_L1_negativeQonly_lamda095_psobs_target960error1_window1h/result/tc_hires/200001'
...
for day in range(7,10):
    ...
    for hour in range(0,24,1):
        ...
        if i != 0:
            ...
            plt.savefig('./demo_test_20250914_tchires_letkc_L1_negativeQonly_lamda095_psobs_target960error1_window1h/'+figname)
            plt.clf()
        i = i + 1
        #show()
