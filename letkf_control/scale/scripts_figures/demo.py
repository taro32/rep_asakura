...
# LETKF mdet
baseline = '/work/jh220020o/f00019/scale_enkc/20241115_nocontrol_obserr01_denseob/result/case_tc/200001'
#workdir_letkf = '/work/jh220020o/f00019/scale_enkc/20241107_letkc_qvonly_noqc_local09_obserr01/result/case_tc/200001'
workdir_letkf = '/work/gv42/f00019/enkc_with_TC/20241213_letkc_qvonly_noqc_local07anddist_hv_target990/result/case_tc/200001'
...
for day in range(2,10):
    ...
    for hour in range(0,24,3):
        ...
        if i != 0:
            ...
            plt.savefig('./20241213_letkc_qvonly_noqc_local07anddist_hv_target990/'+figname)
            plt.clf()
        i = i + 1
        #show()
