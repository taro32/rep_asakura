...
for day in range(2,10):
    ...
    for hour in range(0,24,3):
        ...
        if i != 0:
            ...
            increment = valuenew[0,14,:,:] - valueold[1,14,:,:]
            ...
            figname = "demo"+valuename+'_'+strday+strhour+'U_14_15'
            plt.savefig('./20241212_letkc_windonly_noqc_local07anddist_target990/'+figname)
            plt.clf()
        i = i + 1
        #show()
