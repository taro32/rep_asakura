...
def calc_axis (strday, strhour):
    workdir_letkf = '/work/gv42/f00019/enkc_with_TC/20250925_tchires_letkc_L1_negativeQonly_lamda099_psobs_target960error1_window1h/result/tc_hires/200001'
    ...
    np.savetxt('hydrometeoraxis_20250925_tchires_letkc_L1_negativeQonly_lamda099_psobs_target960error1_window1h_'+str(strday)+str(strhour)+'.txt', valueaxis)
    ...
    plt.colorbar()
    plt.savefig('hydrometeoraxis_20250925_tchires_letkc_L1_negativeQonly_lamda099_psobs_target960error1_window1h_'+str(strday)+str(strhour)+'.png')
