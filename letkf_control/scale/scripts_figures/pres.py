...
workdir_letkf2 = '/work/gv42/f00019/enkc_with_TC/20250715_tchires_letkc_allQ_lamda08_psobs/result/tc_hires/200001'
...
plt.savefig('TCpres_tchires_letkc_allQ_lamda08_psobs.png')
plt.show()
