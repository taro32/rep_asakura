...
workdir_letkf2 = '/work/gv42/f00019/enkc_with_TC/20250902_tchires_letkc_L1to5Q_lamda09_psobs_target960error1_window1h/result/tc_hires/200001'
...
plt.savefig('pres_tchires_letkc_L1to5Q_lamda09_psobs_target960error1_window1h.png')
plt.show()
