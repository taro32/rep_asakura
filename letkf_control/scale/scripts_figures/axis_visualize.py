...
filename = 'hydrometeoraxis_20250925_tchires_letkc_L1_negativeQonly_lamda05_psobs_target960error1_window1h.txt'
valueaxis = np.loadtxt(filename)
filename = 'hydrometeoraxis_20250717_tchires_letkc_baseline.txt'
...
plt.colorbar()
plt.savefig('hydrometeoraxisdiff_20250925_tchires_letkc_L1_negativeQonly_lamda05_psobs_target960error1_window1h.png')
plt.show()
